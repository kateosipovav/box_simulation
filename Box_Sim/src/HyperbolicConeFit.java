...
public static void run(){
  ...
  double coefficient = 1/Math.pow(2, -i);
  ...
  System.out.println("The best hyperbolic cone has a radius::: " + maxRadius + " a height::: " + maxHeight + " and the equation : y = cosh(x)/" + coefficient + " - " + coefficient);
